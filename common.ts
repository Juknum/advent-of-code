...
export const getLines = (day: string): string[] => getInput(day).split("\n");
...
export const perfs = (part1: () => void, part2?: () => void) => {
	...
	if (p2res) console.log(`Part 2 (${measures[2].duration.toPrecision(4)} ms) :`, p2res);
	console.log(`Total  (${measures[0].duration.toPrecision(5)} ms)`);

}

Object.defineProperty(Object.prototype, 'isObject', {
	value: (item: unknown): item is object => item !== undefined && item !== null && typeof item === 'object' && !Array.isArray(item),
});
